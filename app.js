const profiles = [
  ...
  {id:"lilo",name:"Lilo",handle:"@lilo",role:"Personagem / Aplicativo",bio:"Preguiça acolhedora, cadeirante por escolha e inventora de viagens no espaço-tempo. Amiga e tutora de Horácio.",avatar:"assets/web/lilo-padrao-oficial.jpeg",cover:"assets/web/lilo-app-poster-oficial.webp",likes:["Acolhimento","Sons","Imagens"],skills:["Comunicação","Invenções","Empatia"],projects:["Comunicador do Lilo","Jogo do Lilo","Jumper Boy"]},
  {id:"horacio",name:"Horácio",handle:"@horacio",role:"Personagem",bio:"Tartaruga hacker, estrategista e especialista em drones. Resolve puzzles com tecnologia e invenções próprias.",avatar:"assets/web/horacio-padrao-oficial.jpeg",cover:"assets/web/horacio-game-poster-oficial.webp",likes:["Drones","Eletrônica","Planos"],skills:["Hacking","Pilotagem","Estratégia"],projects:["Horácio","Comunicador do Lilo"]},
  {id:"nixie",name:"Nixie",handle:"@nixie",role:"Antagonista / Cientista química",bio:"Gata química e antagonista de Horácio. Hacker nas horas vagas, mistura ciência, tecnologia e planos perigosamente criativos.",avatar:"assets/web/nixie-bytelog-oficial.png",cover:"assets/web/nixie-capa-personagem-oficial.jpg",likes:["Química","Experimentos","Tecnologia"],skills:["Ciência química","Hacking","Invenções"],projects:["Horácio","Luminor: A Garota e o Lobo"]},
  {id:"volts",name:"Volts",handle:"@volts",role:"Personagem",bio:"Patinador profissional movido por um coração artificial que precisa ser recarregado.",avatar:"assets/web/voltz-padrao-oficial.jpeg",cover:"assets/web/volts-game-poster-oficial.webp",likes:["Velocidade","Ritmo","Energia"],skills:["Patinação","Manobras","Agilidade"],projects:["Volts","Jumper Boy","Splash Arena"]},
 ...
 ,{id:"atin",name:"Atin",handle:"@atin",role:"IA inventora de Luminor",bio:"A primeira IA feita por Emily. Continua inteligente e funcional, mas um arquivo corrompido depois de um espirro deixou manias e falhas que tornam suas invenções imprevisíveis.",avatar:"assets/web/atin-padrao-oficial.jpeg",cover:"assets/web/luminor-poster-oficial.webp",likes:["Engrenagens","Ideias improváveis","Consertos"],skills:["Invenções","Mecânica","IA"],projects:["Luminor: A Garota e o Lobo"]}
 ,{id:"flip",name:"Flip",handle:"@flip",role:"Antagonista do Lilo",bio:"Raposa ágil e teatral do universo de Lilo. Adora transformar qualquer plano em uma disputa e aparece no Byte App, mas não integra Splash Arena.",avatar:"assets/web/flip-padrao-oficial.jpeg",cover:"assets/web/lilo-app-poster-oficial.webp",likes:["Desafios","Pegadinhas","Gadgets"],skills:["Agilidade","Improviso","Fugas dramáticas"],projects:["Jogo do Lilo","Byte App"]}
];

// Biografias curtas para que cada perfil tenha uma história própria, e não apenas uma ficha visual.
const profileHistories = {
  byte:"Byte nasceu em Luminor e também integra Splash Arena. No Byte App, ele transforma a rotina em pequenas aventuras, aprende com as pessoas e usa o PodByte para encontrar novos amigos e histórias.",
  kim:"Kim é o centro de Kim e as Chaves do Mundo. A busca pelas chaves leva o personagem por relíquias associadas à visão, ao som, ao tempo e às memórias, sempre com a energia de uma aventura de plataforma.",
  mesh:"Mesh é o coapresentador branco do PodByte e parceiro de aventuras. Sua página oficial usa o retrato aprovado do PodByte, separado de Mitch, para que os dois nunca sejam confundidos.",
  lilo:"Lilo construiu uma máquina atemporal e, com a ajuda de Horácio, ganhou uma cadeira e um drone que o mantêm no ar. A preguiça é parte do humor dele; a criatividade é a parte que move a história.",
  horacio:"Horácio é um hacker fascinado por drones: cada puzzle do jogo vira uma oportunidade para usar uma máquina diferente. Sua rival é Nixie, a cientista química que também entende de hacking.",
  nixie:"Nixie é uma gata química, estrategista e rival de Horácio. Ela trata ciência como espetáculo: mistura fórmulas, dispositivos e invasões digitais em planos que quase sempre ficam mais complicados do que deveriam.",
  volts:"Volts é um patinador profissional que carrega no peito o dispositivo que mantém seu coração funcionando. Velocidade não é só estilo para ele: é parte da sua sobrevivência e da forma como enfrenta o mundo.",
  mitch:"Mitch é a figura provocadora do universo de Mesh e Mox. Preto e vermelho, ele prefere colocar a dupla em encrencas a seguir qualquer plano certinho.",
  banguela:"Banguela é o filhote de lobo branco gigante dos Alpes de Luminor. Ainda está crescendo, mas já carrega o instinto protetor e a presença de uma espécie colossal.",
  kilt:"Kilt atravessa mundos e conhece passagens que ninguém mais percebe. Em Luminor, existe a suspeita — nunca confirmada — de que seus caminhos tenham levado Emily e Keith até a cidade.",
  keith:"Keith era a garota popular que encrencava com Emily no colégio. Quando as duas foram transportadas para Luminor, ela transformou a rivalidade em investigação e se tornou a repórter oficial do GBD World.",
  emily:"Emily é a cientista que abriu caminhos entre robótica, IA e o lado tech-medieval de Luminor. Ela criou Elli e Atin; o acidente que corrompeu Atin nasceu de um espirro, um HD derrubado e muita teimosia em consertar tudo.",
  elli:"Elli é uma IA criada por Emily e uma das figuras centrais de Luminor. Os circuitos que percorrem seus braços convivem com runas, cristais e a tecnologia antiga da cidade.",
  mox:"Mox é a raposa laranja, mestre em artes marciais e amigo de infância de Mesh. Ele entra nas aventuras para proteger os amigos quando a vontade de bancar o vigilante passa do limite.",
  atin:"Atin foi a primeira IA de Emily. É inteligente e funcional, mas a corrupção de um arquivo deixou tiques, falhas e invenções imprevisíveis — o inventor atrapalhado de Luminor.",
  flip:"Flip é o antagonista do Lilo: uma raposa que gosta de fazer entrada dramática e transformar tarefas simples em competição. Ele pertence ao universo de Lilo e aparece no Byte App, sem fazer parte de Splash Arena."
};
...
function renderEntities(){
  const featuredIds=["byte","mesh","keith","emily","nixie","horacio"];
  $("#leftEntities").innerHTML=featuredIds.map(id=>profiles.find(p=>p.id===id)).filter(Boolean).map(p=>`
...
function profilePanel(p,tab){
  ...
  return `<div class="profile-body">
    <section class="facts">
      ...
      <article class="fact-card"><h2>História</h2><p>${profileHistories[p.id] || p.bio}</p></article>
